...
@Repository
public interface OferenteCaracteristicaRepository extends JpaRepository<OferenteCaracteristica, Long> { //define la interfaz que va manejar la tabla de empresa
}