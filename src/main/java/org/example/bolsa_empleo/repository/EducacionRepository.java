...
import org.example.bolsa_empleo.entidades.Educacion;
...
@Repository
public interface EducacionRepository extends JpaRepository<Educacion, Long> { //define la interfaz que va manejar la tabla de empresa
}