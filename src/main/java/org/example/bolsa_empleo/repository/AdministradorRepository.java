...
@Repository
public interface AdministradorRepository extends JpaRepository<Administrador, String> { //define la interfaz que va manejar la tabla de empresa

    Optional<Administrador> findByCorreoAdministrador(String correoAdministrador);
